        ...
        <div id="cuerpo_datos_personales">
            <div class="seccion-perfil">
                <div class="grupo-perfil" id="grupo_iperfil">
                    <!-- CAMBIAR CONTRASEÑA-->
						<div class="titulo-perfil">REESTABLECER CONTRASEÑA</div>
						<div class="item-datos">
							<span>Contraseña Nueva</span>
							<span>Repita Contraseña Nueva</span>
						</div>
						<div class="datos-personales">
							<input type="password" placeholder="Ingrese Contraseña nueva" id="pass" name="contra-nueva"
							onfocus="SombrearCampo('pass',true); " onblur="validarTamañoContraseñas('pass')";
							required>
							<div class="rpta-seccion" id="rpta-contra-nueva"></div>

							<input type="password" placeholder="Repita Contraseña nueva" id="passb" name="contra-repetida"
							onfocus="SombrearCampo('passb',true); " onblur="validarTamañoContraseñas('passb')";
							required>
							<div class="alertpass" id="igual"></div>
						</div>
