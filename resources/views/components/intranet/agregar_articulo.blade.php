        ...
        <div id="cuerpo_datos_personales">
            ...
            <div class="seccion-perfil">
                <div class="grupo-perfil" id="grupo_iperfil">
                    <div class="titulo-perfil">AGREGAR ARTÍCULO</div>
                    ...
                    <form method="post" id="formulario">
                        ...
                        <div class="datos-personales">
                            <input type="text" placeholder="Ingrese Nombre" value=""
                                   id="nombres"
                                   name="nombres" 
                                   onKeyUp="this.value = this.value.toUpperCase();"  required>
                            <div class="rpta-seccion" id="rpta-nombres"></div>

                            <input type="text" placeholder="Ingrese Descripción" value=""
                                   id="apellidos" name="apellidos" 
                                   onKeyUp="this.value = this.value.toUpperCase();" required>
                            <div class="rpta-seccion" id="rpta-apellido"></div>

                            <input type="number" id="dni" placeholder="Ingrese Stock"
                                   value="">

                            <input type="number" id="dni" placeholder="Ingrese Precio"
                                   value="">

                            <select  name="" id="genero" required>
                                <option value="0" id="genero" selected>Selecione Categoría</option>
                            ...
                            <select  name="" id="genero" required>
                                <option value="0" id="genero" selected>Selecione Modelo</option>
                            </select>
